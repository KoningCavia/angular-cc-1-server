...
const app = express();
const port = 3000;      // our project will run at port 3000
...
// example: localhost:3000/clothes?page=0&perPage=2 -GET        //page  = 0 is first page. perPage uses slice to show the corresponding items if you were on page 2 or something
